...
function extractAllPrices(html) {
  ...
  for (const block of tableBlocks) {
    ...
    for (const row of rows) {
      ...
      // Skip 24节气 section headers (parsed as fake products in 个性茅台系列)
      if (productName.match(/^(立春|雨水|惊蛰|春分|清明|谷雨|立夏|小满|芒种|夏至|小暑|大暑|立秋|处暑|白露|秋分|寒露|霜降|立冬|小雪|大雪|冬至|小寒|大寒)(\s*热!)?$/)) continue;
